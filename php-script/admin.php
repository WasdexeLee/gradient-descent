...
function getFoodItem(&$connection){
    ...
    $query_template = "SELECT food_id, food_name, food_category_name, food_description, food_price, food_availability, food_image, food_prep_time, food_num_sold FROM Food JOIN FoodCategory ON Food.food_category_id=FoodCategory.food_category_id";
    ...
    $prepared_query->bind_result($result[Food::ID->value], $result[Food::NAME->value], $result[Food::CATEGORY_NAME->value], $result[Food::DESCRIPTION->value], $result[Food::PRICE->value], $result[Food::AVAILABILITY->value], $result[Food::IMAGE->value], $result[Food::PREP_TIME->value], $result[Food::NUM_SOLD->value]);


    // Fetch all response from server
    while ($prepared_query->fetch())
        $pass[] = [$result[Food::ID->value], $result[Food::NAME->value], $result[Food::CATEGORY_NAME->value], $result[Food::DESCRIPTION->value], $result[Food::PRICE->value], $result[Food::AVAILABILITY->value], $result[Food::IMAGE->value], $result[Food::PREP_TIME->value], $result[Food::NUM_SOLD->value]];
